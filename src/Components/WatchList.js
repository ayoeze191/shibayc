...
const WatchList = () => {
  ...
  return (
    <div className='flex flex-col flex-1  items-center gap-5 md:pt-14 font-poppins-Regular w-full relative'>
        ...
        <div className='flex w-11/12 mx-auto items-center justify-center max-w-lg gap-2 relative'>
                <input type='text' placeholder='Paste Your Eth Address Here rounded-md' className='flex-1 h-full rounded-lg'/>
          ...
          <div className=' w-4/5 max-w-4xl flex bg-[#101722] long-div text-white overflow-x-scroll text-[12px] mx-auto gap-1'>
