...
const WatchList = () => {
  return (
    <div className='flex flex-col flex-1  items-center gap-5 md:pt-14 font-poppins-Regular'>
        ...
        <div className='flex items-center gap-4 w-fit flex-col sm:flex-row'>
            ...
            <div className='text-white bg-slate-900  md:flex px-[0.15rem] gap-[0.15rem] long-div grid grid-cols-2 sm:grid-cols-3 w-11/12 md:w-fit'>
