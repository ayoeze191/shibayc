  ...
  return (
    <div className='flex flex-col flex-1  items-center gap-5 md:pt-14 font-poppins-Regular w-11/12'>
        ...
        <div className='flex w-11/12 mx-auto items-center justify-center max-w-lg bg-black'>
                <input type='text' placeholder='Paste Your Eth Address Here rounded-md' className='flex-[0.8]'/>
                <button className='flex bg-d flex-[0.2]  rounded-right justify-center  items-center text-white'><FaSearch fontSize='1.25rem' color='white'/>Go</button>
            </div>
